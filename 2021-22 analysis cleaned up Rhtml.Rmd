...
ggplot(comdataRTA.2, aes(x = Period, y = Freckled.Duck, alpha = 0.2, shape = factor(Sympch))) + scale_shape_manual(values = c(1, 16)) +
  geom_point(position = position_jitterdodge(dodge.width = 0.1), size = 10, colour="blue") + scale_x_discrete(limits = c("Reference","1996","2017","2021/22")) + theme(legend.position = "none")
