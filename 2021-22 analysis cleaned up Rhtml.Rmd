...
clusanal_d <- as.dendrogram(clusanal)
label_colours(clusanal_d)


plot(clusanal, las = 1, xlab="Survey", ylab="Bray", col = clusanal$colour)

dendro_label(clusanal)
...
```{r}
rawdata.I3.2 <- as.data.table(rawdata.I3)
rawdata.I3.2$group <- groups$Column1
