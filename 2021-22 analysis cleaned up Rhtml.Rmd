...
```{r eval = FALSE}
comdataA <- rawdata[rawdata$All_Ref == "Y", ]
comdataA <- comdataA[!rownames(comdataA) == "T1075", ]
comdataA.fact <- comdataA[, 1:7] #seperate out factors
comdataA.fact$Survey <- row.names(comdataA.fact)
comdataA <- comdataA[, -(1:7)] #remove factors from data file
...
mds3.pts$Depth <- comdataA.fact[match(mds3.pts$Survey, comdataA.fact$Survey), 6]
```
...
##nmds analyses of just Toolibin comprehenasive surveys
