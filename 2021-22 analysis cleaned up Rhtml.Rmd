...
groups$sample <- row.names(groups)
groups$order <- clusanal$order
group_colours <- groups$Column1


CREATE NEW GROUPS from clusanal

plot(clusanal, las = 1, xlab="Survey", ylab="Bray")
