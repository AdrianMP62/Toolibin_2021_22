...
packages <- c("data.table","mtcars","dplyr","scatterplot3d","plotly","RColorBrewer","stringr","rstudioapi","patchwork","glue","ClassDiscovery","vegan","tidyverse","lubridate","ggplot2","ggpubr","stringi","factoextra", "zoo","cluster","rgl","reshape2","ggthemes","data.table")
...
###Freckled Duck
comdataRTA.2[, Sympch := ifelse(Freckled.Duck == "0", 1, 16)]
comdataRTA.2$Sympch <- as.factor(comdataRTA.2$Sympch)
comdataRTA.2$Sympch <- as.factor(comdataRTA.2$Sympch)
ggplot(comdataRTA.2, aes(x = Period, y = Freckled.Duck, alpha = 0.2, shape = factor(Sympch))) + scale_shape_manual(values = c(1, 16)) +
  geom_point(position = position_jitterdodge(dodge.width = 0.1), size = 10, colour="blue") + scale_x_discrete(limits = c("Reference","1996","2017","2021/22")) + theme(legend.position = "none") + theme(axis.text = element_text(size = 14)) + theme(axis.title = element_text(size=15)) + ylab("Abundance") + ggtitle("Freckled Duck") + theme(plot.title = element_text(size = 15)) + theme(
    axis.title.x = element_text(margin = margin(t = 10)), axis.title.y = element_text(margin = margin(r = 10))) + geom_hline(yintercept = 0.5, linetype = "dashed", color = "red")

###Australian Shelduck
comdataRTA.2[, Sympch := ifelse(Australian.Shelduck == "0", 1, 16)]
comdataRTA.2$Sympch <- as.factor(comdataRTA.2$Sympch)
comdataRTA.2$Sympch <- as.factor(comdataRTA.2$Sympch)
ggplot(comdataRTA.2, aes(x = Period, y = Australian.Shelduck, alpha = 0.2, shape = factor(Sympch))) + scale_shape_manual(values = c(1, 16)) +
  geom_point(position = position_jitterdodge(dodge.width = 0.1), size = 10, colour="blue") + scale_x_discrete(limits = c("Reference","1996","2017","2021/22")) + theme(legend.position = "none") + theme(axis.text = element_text(size = 14)) + theme(axis.title = element_text(size=15)) + ylab("Abundance") + ggtitle("Australian Shelduck") + theme(plot.title = element_text(size = 15)) + theme(
    axis.title.x = element_text(margin = margin(t = 10)), axis.title.y = element_text(margin = margin(r = 10)))

### Pink-eared Duck
comdataRTA.2[, Sympch := ifelse(Pink.eared.Duck == "0", 1, 16)]
comdataRTA.2$Sympch <- as.factor(comdataRTA.2$Sympch)
comdataRTA.2$Sympch <- as.factor(comdataRTA.2$Sympch)
ggplot(comdataRTA.2, aes(x = Period, y = Pink.eared.Duck, alpha = 0.2, shape = factor(Sympch))) + scale_shape_manual(values = c(1, 16)) +
  geom_point(position = position_jitterdodge(dodge.width = 0.1), size = 10, colour="blue") + scale_x_discrete(limits = c("Reference","1996","2017","2021/22")) + theme(legend.position = "none") + theme(axis.text = element_text(size = 14)) + theme(axis.title = element_text(size=15)) + ylab("Abundance") + ggtitle("Pink-eared Duck") + theme(plot.title = element_text(size = 15)) + theme(
    axis.title.x = element_text(margin = margin(t = 10)), axis.title.y = element_text(margin = margin(r = 10)))

### Eurasian Coot
comdataRTA.2[, Sympch := ifelse(Eurasian.Coot == "0", 1, 16)]
comdataRTA.2$Sympch <- as.factor(comdataRTA.2$Sympch)
comdataRTA.2$Sympch <- as.factor(comdataRTA.2$Sympch)
ggplot(comdataRTA.2, aes(x = Period, y = Eurasian.Coot, alpha = 0.2, shape = factor(Sympch))) + scale_shape_manual(values = c(1, 16)) +
  geom_point(position = position_jitterdodge(dodge.width = 0.1), size = 10, colour="blue") + scale_x_discrete(limits = c("Reference","1996","2017","2021/22")) + theme(legend.position = "none") + theme(axis.text = element_text(size = 14)) + theme(axis.title = element_text(size=15)) + ylab("Abundance") + ggtitle("Eurasian Coot") + theme(plot.title = element_text(size = 15)) + theme(
    axis.title.x = element_text(margin = margin(t = 10)), axis.title.y = element_text(margin = margin(r = 10)))

### Black-winged Stilt
comdataRTA.2[, Sympch := ifelse(Black.winged.Stilt == "0", 1, 16)]
comdataRTA.2$Sympch <- as.factor(comdataRTA.2$Sympch)
comdataRTA.2$Sympch <- as.factor(comdataRTA.2$Sympch)
ggplot(comdataRTA.2, aes(x = Period, y = Black.winged.Stilt, alpha = 0.2, shape = factor(Sympch))) + scale_shape_manual(values = c(1, 16)) +
  geom_point(position = position_jitterdodge(dodge.width = 0.1), size = 10, colour="blue") + scale_x_discrete(limits = c("Reference","1996","2017","2021/22")) + theme(legend.position = "none") + theme(axis.text = element_text(size = 14)) + theme(axis.title = element_text(size=15)) + ylab("Abundance") + ggtitle("Black-winged Stilt") + theme(plot.title = element_text(size = 15)) + theme(
    axis.title.x = element_text(margin = margin(t = 10)), axis.title.y = element_text(margin = margin(r = 10)))

### Grey Teal
comdataRTA.2[, Sympch := ifelse(Grey.Teal == "0", 1, 16)]
comdataRTA.2$Sympch <- as.factor(comdataRTA.2$Sympch)
comdataRTA.2$Sympch <- as.factor(comdataRTA.2$Sympch)
ggplot(comdataRTA.2, aes(x = Period, y = Grey.Teal, alpha = 0.2, shape = factor(Sympch))) + scale_shape_manual(values = 16) +
  geom_point(position = position_jitterdodge(dodge.width = 0.1), size = 10, colour="blue") + scale_x_discrete(limits = c("Reference","1996","2017","2021/22")) + theme(legend.position = "none") + theme(axis.text = element_text(size = 18)) + theme(axis.title = element_text(size=15)) + ylab("Abundance") + ggtitle("Grey.Teal") + theme(plot.title = element_text(size = 18)) + theme(
...
ggplot(data=comdataRT.h, aes(x=reorder(date, order), rich)) + 
  geom_col() + theme(axis.text.x = element_text(angle = 45, vjust = 1, hjust=1, size=7)) + labs(x="Survey date",y="Species richness", size=10) + ggtitle("Species richness") + theme(plot.title = element_text(vjust = -8, hjust = 0.1))
```
