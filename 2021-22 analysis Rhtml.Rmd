...
###Toolibin using only surveys with 10+ species and depth >0.3m
...
```{r}
comdataRT <- rawdata[rawdata$RICHNESS > 0, ]
...
```{r include=FALSE}
mds5<-metaMDS(comdataRT.hel, distance="bray", k=2) #nMDS in 3 dimensions
```
...
###Produce heatmap with siurveys clustered by Kmeans
