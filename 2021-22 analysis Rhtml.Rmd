...
##Simper analysis of just the comprehensive surveys
```{r}
comdataRTA <- rawdata[rawdata$All_Ref == "Y", ]
...
comdataRTA.fact <- comdataRTA[, 1:7]
comdataRTA <- comdataRTA[, -(1:7)] #remove factors from data file
