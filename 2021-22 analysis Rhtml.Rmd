...
packages <- c("scatterplot3d","RColorBrewer","stringr","rstudioapi","patchwork","glue","ClassDiscovery","vegan","tidyverse","lubridate","ggplot2","ggpubr","stringi","factoextra", "zoo","cluster","rgl","reshape2","ggthemes","data.table")
...
plot3d(x = mds3.I.pts$MDS1, y = mds3.I.pts$MDS2, size=12, z = mds3.I.pts$MDS3, col = mds3.I.pts$Col, cex=12, pch=19, type="p", xlim=c(-1.0, 1.0), ylim=c(-1.0, 1.0), zlim=c(-1.0, 1.0))

scatterplot3d(mds3.I.pts$MDS1,mds3.I.pts$MDS2,mds3.I.pts$MDS3, pch=16, cex.symbols=2, color = mds3.I.pts$Col, type="h", angle=45, xlim=c(-1.0, 1.0), ylim=c(-1.0, 1.0), zlim=c(-1.0, 1.0))
```
