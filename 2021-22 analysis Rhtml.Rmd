...
plot3d(x = mds3.I.pts$MDS1B, y = mds3.I.pts$MDS2B, size=12, z = mds3.I.pts$MDS3B, col = mds3.I.pts$Col, cex=12, pch=16, type="h") 

xlim=c(-1.0, 1.0), ylim=c(-1.0, 1.0), zlim=c(-1.0, 1.0))
...
plot_ly(color = I("black"), showlegend = F) %>%
  add_markers(data = mds3.I.pts, x = ~MDS1, y = ~MDS2, z = ~MDS3) %>%
...
To get this to work need to convert mds3.I.pts$wetland to numeric (1,2,3)
